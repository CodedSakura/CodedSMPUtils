...
//            backwards = world.getPersistentStateManager().get(WarpListComponent::readBackwardsNbt, "cardinal_world_components");
//            if (backwards == null) backwards = world.getPersistentStateManager().get(WarpListComponent::readNbt, "cardinal_world_components");
//        }
//        WarpListComponent finalBackwards = backwards;
        return world.getPersistentStateManager().getOrCreate(WarpListComponent::readNbt, WarpListComponent::new, FILE_KEY);
    }
...
//            warp.readFromNbt(nbt.getCompound("fabricwarps:warplist"));
//            return warp;
//        }
//        if (tag.contains("fabric-smp-utils:warps")) {
//            warp.readFromNbt(nbt.getCompound("fabric-smp-utils:warps"));
//            return warp;
//        }
//        return null;
//    }
