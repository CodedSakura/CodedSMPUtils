...
public class Back extends Requirements {
    ...
    @Property("boss-bar")
    public String bossBar = "purple"; // null if off
    @Property("action-bar")
    ...
    @Required
    @Property
    public BoolExpression cost;
    @Property("requirement-relation")
    public Relation requirementRelation = Relation.OR;

    @Property("allow-death-point")
    public boolean allowDeathPoint = false;
}
